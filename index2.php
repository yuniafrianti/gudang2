  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index2.php?id=16"><i class="fa fa-book"></i> <span>Barang Masuk</span></a></li>
        <li><a href="index2.php?id=17"><i class="fa fa-book"></i> <span>Barang Keluar</span></a></li>
        <li><a href="index2.php?id=13"><i class="fa fa-book"></i> <span>Stock Barang</span></a></li>
